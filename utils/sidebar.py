...
def show_sidebar_options():
    locations = [
        ...
        },
        {
            "id": "lexington",
            "name": "Lexington Ave",
            "address": "1101 Lexington Ave, New York",
            "lat": 40.7736204,
            "lon": -73.9595174,
            "tz": "America/New_York",
            "units": "imperial",
        ...
        },
        {
            "id": "east-23rd",
            "name": "East 23rd St",
            "address": "210 E 23rd St, New York",
            "lat": 40.7383416,
            "lon": -73.9825668,
            "tz": "America/New_York",
            "units": "imperial",
...
def show_map_sidebar_code_examples():
    ...
    st.sidebar.caption(
        "Get the code for this app at [GitHub](https://github.com/predicthq/streamlit-amex-pick-a-bagel-demo)"
    )
